...
1. **Prerequisites**: 
   - Unity Hub and a compatible Unity Editor version (supporting URP).
   - Git with [Git LFS](https://git-lfs.github.com/) installed (crucial for downloading the 3D models and scenes).

2. **Clone the repository:**
   ```bash
   git lfs install
   git clone https://github.com/Manish9211Ram/Bharat_Blaze---a-gta-replica.git
   ```
...
4. **Open the Main Scene:**
   In the Project window, navigate to `Assets/Scenes/Game Scene.unity` and double-click to load the core environment.

5. **Play!**
   Hit the Play button in the editor to jump in and start exploring.
